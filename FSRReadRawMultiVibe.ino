...
void loop(void) {
    ...
    if (deviceConnected) {
     ...
     if((millis() - time_3) >= vibperiod2 && vibmotoract == 2 && passnextvib==0){
      digitalWrite(vibmot, HIGH);
      vibmotoract = 2;
      passnextvib = 1;
      }

     if((millis() - time_3) >= vibperiod3 && vibmotoract == 2 && passnextvib == 1){
      digitalWrite(vibmot, LOW);
      vibmotoract = 2;
      passnextvib = 2;
      }
     if((millis() - time_3) >= vibperiod4 && vibmotoract == 2 && passnextvib == 2){
      digitalWrite(vibmot, HIGH);
      vibmotoract = 2;
      passnextvib = 3;
      }
      ...
      if((millis() - time_3) >= vibperiod5 && vibmotoract == 2 && passnextvib == 3){
      digitalWrite(vibmot,LOW);
      pCharacteristic2->setValue("0");
      pCharacteristic2->notify();
      vib2state = 0;
